function create_user(){
	...
	var fq_tmp;
	function usr_success(){ $('#customer-login-wrap').fadeOut().empty().html("<div id='contrats' style='margin-bottom: 40px;'><h3 style='color: rgb(211, 1, 141); font-style: normal; font-size: 14pt; font-weight: 600; margin: 40px 0px 0px;'>Your size information has been saved!</h3><p>You will receive an email within 24 hours with a link to activate your profile and select a password.</p><p style='font-size: 10pt;'>Get <span style='font-weight: bold; color: rgb(211, 1, 141);'>15% off</span> your first order with the code <span style='font-weight: bold; color: rgb(211, 1, 141);'>FALLINTOQUINCY</span>.</p></div>").fadeIn();}
